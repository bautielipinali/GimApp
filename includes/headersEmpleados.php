...
<body>
    <header>
        ...
        <a href="../crudEmpleados/registerVeterinario.php">CREATE</a>
        <a href="../crudEmpleados/read.php">READ</a>
        <a href="../crudEmpleados/delete.php">DELETE</a>
        <a href="../crudEmpleados/update.php">UPDATE</a>
